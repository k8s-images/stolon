...
![AppVersion: 0.17.0](https://img.shields.io/badge/AppVersion-0.17.0-informational?style=flat-square)
...
| keeper.image.tag | string | `"0.17.0-13.13-r4"` |  |
...
| postgresUtils.image.tag | string | `"13.13-r4"` |  |
...
| proxy.image.tag | string | `"0.17.0-r4"` |  |
...
| sentinel.image.tag | string | `"0.17.0-r4"` |  |
...
| stolonctl.image.tag | string | `"0.17.0-r4"` |  |
